...
function Ranking() {
  ...
  const columns = useMemo(() => {
    ...
    return rankingColumns.map((col) => ({ header: col, accessorKey: col }));
  }, [rankingData]);

  return (
    <section id="ranking" className="py-10 px-14 bg-stone-200 -mx-10">
      <div className="flex items-center gap-x-3">
        ...
        <div className="group relative">
          ...
          <div className="opacity-0 pointer-events-none group-hover:opacity-100 absolute -right-42 sm:left-0 top-5 bg-stone-600 p-4 rounded-md text-xs text-white transition w-[280px] sm:w-[350px] z-10">
            <p>
