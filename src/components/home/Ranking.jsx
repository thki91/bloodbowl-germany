...
function Ranking() {
  ...
  return (
    <section id="ranking" className="pt-10">
      <div className="flex items-center gap-x-3">
        ...
        <div className="group relative">
          ...
          <div className="opacity-0 pointer-events-none group-hover:opacity-100 absolute left-0 top-5 bg-stone-600 p-4 rounded-md text-xs text-white transition w-[350px]">
            <p>
              {" "}
      ...
      {rankingData?.length && (
        <>
          ...
          <a
            className="text-center pt-2 lg:pt-4 block"
