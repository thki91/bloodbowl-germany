...
const News = ({}) => {
  ...
  const NewsItem = ({ news }) => {
    return (
      <div className="rounded-sm flex-[45%] mb-7 sm:mb-6 lg:mb-10 text-white text-sm md:text-base">
  ...
  return (
    <>
      ...
      <div
        className="max-w-[350px] sm:max-w-[450px] md:max-w-[500px] mt-5 md:mt-10 mb-8 sm:mb-0 pr-5 sm:pr-0"
        id="news-carousel"
      >
        <CarouselDefault
